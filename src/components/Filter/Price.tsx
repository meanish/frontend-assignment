    ...
    <>
      <div className="flex items-center space-x-2">
        ...
        <div className="choose">
          <select
            className="appearance-none p-2 text-blue-500  hover:text-blue-700 border-gray-200 border-2 add-border-radius bg-white  pl-2 pr-11 rounded-full focus:ring-0 focus:outline-none transition-all duration-300 ease-in-out"
        ...
        <div className="close relative">
          {selectedPrice && (
            <button
              className="absolute right-3 -top-3 hover:bg-red-600 text-red-200 rounded-full p-1 border-gray-200 border-2 add-border-radius focus:outline-none transition-all duration-300 ease-in-out"
